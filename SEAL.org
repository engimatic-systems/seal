...
** Borrowed line recognition

The recognizer trims horizontal whitespace and returns borrowed key/value slices.
...
#+begin_src odin :tangle seal/config_syntax.odin :name config-syntax
package main
